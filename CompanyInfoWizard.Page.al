        ...
        area(content)
        {
            ...
            group(Step1)
            {
                ...
                group("Welcome to PageName")
                {
                    ...
                    {
                        Caption = 'Step1-1';
                        InstructionalText = 'Step1-1 -  this text with some instructions.';
                    }
                }
                group("Let's go!")
                {
                    ...
                    {
                        Caption = 'Step1-2';
                        InstructionalText = 'Step1-2 -  this text with some more instructions.';
                    }
                }
            }
            ...
            {
                Caption = 'Step2';
                InstructionalText = 'Step2 -  this text with some instructions.';
            ...
            group(Step3)
            {
                ...
                {
                    Caption = 'Step3-1';
                    InstructionalText = 'Step3-1 -  this text with some instructions.';
                }
                group("That's it!")
                {
                    Caption = 'That''s it!';
